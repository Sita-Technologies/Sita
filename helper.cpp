...
template struct tagPERMSYM*** alloc(size_t);
template struct Outline64* alloc(size_t);
template struct tagITEM64* alloc(size_t);
template struct ItemBody64* alloc(size_t);
template struct tagOSEG64* alloc(size_t);
template struct tagOSEG64** alloc(size_t);
template struct HandTable64* alloc(size_t);
template struct HandTable64** alloc(size_t);
template struct tagPERMSYM64** alloc(size_t);
template struct tagPERMSYM64*** alloc(size_t);
